...
> Результат метода: JSON  
    ...
    *message — строка:  
        ...
        ***
        GET /perevals/{id} - получение данных о конкретном горном перевале с выводом всей информации, в том числе статусе.
        ***
        ...
        ***
       Код покрыт тестами.   
       Создана документация Swagger (api/schema/docs/)
